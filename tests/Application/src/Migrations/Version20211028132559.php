...
final class Version20211028132559 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE sylius_payment_provider_transfer ADD shop_internal_id VARCHAR(255) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE sylius_payment_provider_transfer DROP shop_internal_id');
    }
}
