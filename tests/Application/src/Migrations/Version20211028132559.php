...
final class Version20211028132559 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE sylius_payment_provider_transfer CHANGE status state VARCHAR(16) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE sylius_payment_provider_transfer CHANGE state status VARCHAR(10) CHARACTER SET utf8 NOT NULL COLLATE `utf8_unicode_ci`');
    }
}
